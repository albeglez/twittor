...
import (
	...
	"github.com/albeglez/twittor/jwt"
...
func Login(w http.ResponseWriter, r *http.Request) {
	...
	if existe == false {
		http.Error(w, "El email del usuario invalidos", 400)
		return
	}

	jwtKey, err := jwt.GeneroJWT(documento)
	if err != nil {
		http.Error(w, "Ocurrió un error al generar el Token correspondiente"+err.Error(), 400)
		return
	}
